...
#   hermes.py             — allowlisted reasoning and firmware-patch orchestration.
#   llm_client.py         — Backend factory: OpenAI Responses API or isolated Codex CLI.
#   intel_agent.py        — local SQLite vector-index query wrapper.
